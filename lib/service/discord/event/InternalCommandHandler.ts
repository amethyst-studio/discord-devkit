...
// class Event {
//   public constructor(provider: NativeServiceProvider) {
//     provider.getDiscord().on(
//       'interactionCreate',
//       Async.bundle(
//         'InternalInteractionCreateEvent/interactionCreate',
//         async (interaction) => {
...
//                   'InternalInteractionCreateEvent/developerOnlyRestricted',
...
//                 const awaitResponse = await Async.awaitable(
//                   'InternalInteractionCreateEvent/guildOnlyRestricted',
//                   ResponseBuilder.respond(
//                     interaction,
//                     ResponseBuilder.basic({
...
//               'InternalInteractionCreateEvent/execute',
...
//               const awaitResponse = await Async.awaitable(
//                 'InternalInteractionCreateEvent/invalidMessageComponentCustomId',
//                 ResponseBuilder.respond(
//                   interaction,
//                   ResponseBuilder.basic({
...
//             if (ref === null) {
//               const awaitResponse = await Async.awaitable(
//                 'InternalInteractionCreateEvent/messageComponentReferenceNotFound',
//                 ResponseBuilder.respond(
//                   interaction,
//                   ResponseBuilder.basic({
...
//                 'InternalInteractionCreateEvent/component',
...
//             if (interaction.customId === null || interaction.customId.length === 0) {
//               const awaitResponse = await Async.awaitable(
//                 'InternalInteractionCreateEvent/invalidModalCustomId',
//                 ResponseBuilder.respond(
//                   interaction,
//                   ResponseBuilder.basic({
...
//             if (ref === null) {
//               const awaitResponse = await Async.awaitable(
//                 'InternalInteractionCreateEvent/modalReferenceNotFound',
//                 ResponseBuilder.respond(
//                   interaction,
//                   ResponseBuilder.basic({
//                     title: 'Interaction Reference Not Found',
...
//                 'InternalInteractionCreateEvent/modal',
...
//                 'InternalInteractionCreateEvent/autocomplete',
...
//                 'InternalInteractionCreateEvent/autocompleteNoResults',
//                 interaction.respond([{
...
//               const awaitRespond = await Async.awaitable(
//                 'InternalInteractionCreateEvent/autocompleteExactMatch',
...
//                 const awaitRespond = await Async.awaitable(
//                   'InternalInteractionCreateEvent/autocompleteNoResultsFiltered',
//                   interaction.respond([{
//                     name: 'Search returned no results with the current inquiry.',
//                     value: 'null',
//                   }]),
...
//               else {
//                 const awaitRespond = await Async.awaitable(
//                   'InternalInteractionCreateEvent/autocompleteTooManyResults',
//                   interaction.respond([{
...
//             }
//             const awaitRespond = await Async.awaitable(
//               'InternalInteractionCreateEvent/autocompleteChoices',
//               interaction.respond(
//                 choices.slice(
//                   0,
//                   acr.perPage,
